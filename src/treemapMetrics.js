...
export const oaar = n => Math.max((n.x1 - n.x0) / (n.y1 - n.y0), (n.y1 - n.y0) / (n.x1 - n.x0));
export const foaar = n => Math.min((n.x1 - n.x0) / (n.y1 - n.y0), (n.y1 - n.y0) / (n.x1 - n.x0));
export const offsetFactor = (n, ratio) => aspectRatio(n) > ratio ? aspectRatio(n) / ratio : ratio / aspectRatio(n);
export const offsetQuotient = (n, ratio) => aspectRatio(n) < ratio ? aspectRatio(n) / ratio : ratio / aspectRatio(n);
